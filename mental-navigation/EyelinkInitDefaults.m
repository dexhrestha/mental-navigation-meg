...
if ~isempty(window)
	el.window=window;
 	el.backgroundcolour = [255 255 255];%WhiteIndex(el.window);
 	el.backgroundcolour = [127 127 127];
 	el.foregroundcolour = [64 64 64];
     el.msgfontcolour    =[64 64 64];% BlackIndex(el.window);
     el.imgtitlecolour   = [64 64 64];%BlackIndex(el.window);
...
el.calibrationtargetcolour=[64 64 64];
