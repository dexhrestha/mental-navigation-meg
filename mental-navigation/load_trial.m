...
%         WaitSecs(1);
        ...
        [row.movementOnset, row.movementOffset, row.tp, params] = create_movement(row.startId(1),row.speed(1),movementDur,row.visual(1),params);
