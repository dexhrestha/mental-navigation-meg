...
%opt, ptb, i_run, i_block, i_trl)
    ...
    % maybe add date??
    edfFile = sprintf('%s_%d.edf', params.subid,params.runId); %data dump for eyetracking data for a subject
    ...
    Eyelink('command', 'record_status_message "TRIALID %d"', num2str(params.trialId) );
