function [edfFile] = eye_startRecording(params)
%opt, ptb, i_run, i_block, i_trl)
    ...
    edfFile = sprintf('%d_%d_%d.edf', params.runId,params.blockId,params.trialId); %data dump for eyetracking data for a subject
