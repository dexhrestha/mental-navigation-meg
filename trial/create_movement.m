function [movementOnset, movementOffset,movementDa, targetPos, tp, params] = create_movement(startId,targetId,speed,movementDur,visual, params, vbl0)
...
%     KbQueueFlush(params.kbdDeviceIndex);
    ...
    while true
        ...
        if initFlag
            initFlag =  posOfImageX < spacingPx;
        end
%         
        for k = 1:n
